...
public class BlockLeavesBirch extends BlockLeavesBase implements IShearable
{
	public static final String[] LEAF_TYPES = BlockLogBirch.woodType;
	private IIcon[][] iconArray = new IIcon[2][16];
	int[] adjacentTreeBlocks;

	public BlockLeavesBirch() {
	...
	public int colorMultiplier(IBlockAccess par1IBlockAccess, int par2, int par3, int par4) {
		return ColorizerFoliageBirch.getFoliageColorBirch();
	}
