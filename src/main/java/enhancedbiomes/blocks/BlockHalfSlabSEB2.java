...
public class BlockHalfSlabSEB2 extends BlockSlab
{
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		return this == EnhancedBiomesBlocks.slabS2 || this == EnhancedBiomesBlocks.doubleSlabS2 ? Item.getItemFromBlock(EnhancedBiomesBlocks.slabS2) : this == EnhancedBiomesBlocks.slabSC2 || this == EnhancedBiomesBlocks.doubleSlabSC2 ? Item.getItemFromBlock(EnhancedBiomesBlocks.slabSC2) : Item.getItemFromBlock(EnhancedBiomesBlocks.slabSC2);
	}
	...
	protected ItemStack createStackedBlock(int par1) {
		Block block = this == EnhancedBiomesBlocks.slabS2 || this == EnhancedBiomesBlocks.doubleSlabS2 ? EnhancedBiomesBlocks.slabS2 : this == EnhancedBiomesBlocks.slabSB2 || this == EnhancedBiomesBlocks.doubleSlabSB2 ? EnhancedBiomesBlocks.slabSB2 : EnhancedBiomesBlocks.slabSC2;
