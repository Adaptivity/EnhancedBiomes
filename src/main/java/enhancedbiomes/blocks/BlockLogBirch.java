...
public class BlockLogBirch extends BlockRotatedPillar
{
	/** The type of tree this log came from. */
	public static final String[] woodType = new String[] {"alder", "eucalyptus", "aspen", ""};
	public static final String[] names = new String[] {woodNames[8], woodNames[9], woodNames[10], woodNames[11]};
	private IIcon[] field_111052_c = new IIcon[4];
	private IIcon[] tree_top = new IIcon[4];

	protected BlockLogBirch() {
		super(Material.wood);
	...
	protected IIcon getSideIcon(int par1) {
		return this.field_111052_c[par1 % 4];
	}
