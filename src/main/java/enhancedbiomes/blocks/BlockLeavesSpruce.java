...
public class BlockLeavesSpruce extends BlockLeavesBase implements IShearable
{
	public static final String[] LEAF_TYPES = BlockLogSpruce.woodType;
	private IIcon[][] iconArray = new IIcon[2][16];
	int[] adjacentTreeBlocks;

	public BlockLeavesSpruce() {
