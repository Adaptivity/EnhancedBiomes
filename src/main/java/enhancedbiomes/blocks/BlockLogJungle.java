...
public class BlockLogJungle extends BlockRotatedPillar
{
	/** The type of tree this log came from. */
	public static final String[] woodType = new String[] {"baobab", "dead", "cherry", ""};
	public static final String[] names = new String[] {woodNames[12], woodNames[13], woodNames[14], woodNames[15]};
