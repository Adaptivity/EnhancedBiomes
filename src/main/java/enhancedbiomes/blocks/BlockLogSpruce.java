...
public class BlockLogSpruce extends BlockRotatedPillar
{
	/** The type of tree this log came from. */
	public static final String[] woodType = new String[] {"fir", "cypress", "pine", "silverPine"};
	public static final String[] names = new String[] {woodNames[4], woodNames[5], woodNames[6], woodNames[7]};
